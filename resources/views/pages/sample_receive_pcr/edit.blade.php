                    ...
                    <form action="{{ route('sample_receive_pcr.update', $sampleReceivePcr->getKey()) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input col-sm-4" name="conclusion" value="{{$key}}" id="conclusion_{{$conclusion}}" required {{ $sampleReceivePcr->conclusion == $key ? 'checked' : '' }}>
